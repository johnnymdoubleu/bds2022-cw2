...
cat("The optimal value of lambda for Lasso is:", fit.ridge$lambda.min)
cat("The optimal value of lambda for Ridge is:", fit.lasso$lambda.min)
```
...
p1 <- fviz_pca_ind(nki.pca, geom = 'point', habillage = nki$Event, 
                   axes = c(1,2), addEllipses = T, palette = "jco",
