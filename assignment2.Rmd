...
abline(v = 32, col="red", lty=5)
abline(h = 0.90, col="red", lty=5)
legend("topleft", legend=c("Cut-off @ PC32"),
...
```{r warning=FALSE}
fviz_pca_ind(nki.pca, geom='point', habillage = nki$Event, axes = c(1,2), addEllipses = T, palette="jco", legend.title="Diagnosis")
